          ...
          <div class="flex items-center">
            ...
            <div class="hidden sm:ml-6 sm:block">
              <div class="flex space-x-4">
                ...
                <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Board Minutes</a>
                <a href="#" class="rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Memcom Minutes</a>
              </div>
            </div>
          </div>
          <div class="hidden sm:ml-6 sm:block">
